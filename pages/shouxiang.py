...
with st.form('image_form'):
    ...
    if uploaded_file and submitted1:
        ...
        # element = uio.create_element_from_text(text=assistant_response.msg.content+str(sys_role))
        ...
        try:
            graph_element = kg_agent.run(assistant_response.msg.content+str(sys_role), parse_graph_elements=True)
